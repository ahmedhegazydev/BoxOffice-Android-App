...
public class PopularFragment extends Fragment implements AbsListView.OnScrollListener, AdapterView.OnItemClickListener {
    ...
    String pageNumber = "1";
    String url =
            "https://api.themoviedb.org/3/movie/popular?api_key=242d544fe443aa59e56d47a3d5f2d6c4&language=en-US&page=" + pageNumber;
