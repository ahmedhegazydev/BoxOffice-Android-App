...
public class TopRatedFragment extends Fragment implements AbsListView.OnScrollListener, AdapterView.OnItemClickListener {
    ...
    String pageNumber = "1";
    String url =
            "https://api.themoviedb.org/3/discover/movie?page=3&api_key=242d544fe443aa59e56d47a3d5f2d6c4&certification_country=US&certification=R&sort_by=vote_average.desc&page=" + pageNumber;
